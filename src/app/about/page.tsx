                    ...
                    <div className="container mx-auto px-4">
                         <div className="grid md:grid-cols-2 gap-16 items-center">
                            <div className="space-y-6">
                                ...
                                <p className="text-muted-foreground">AI School Mentor started not in a boardroom, but from a simple observation that educational guidance was often generic, disconnected, and overwhelming. The founder, having seen students struggle with one-size-fits-all advice, believed there had to be a better way.</p>
                                <p className="text-muted-foreground">The vision was clear: create a single platform that could act as a true co-pilot for students. It needed to be an intelligent, proactive mentor that understands their unique profile and crafts a hyper-personalized strategy for success. Using the power of generative AI, AI School Mentor was built to do just that.</p>
                            </div>
                            <Image
