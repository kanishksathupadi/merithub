...
const SuggestNextStepInputSchema = z.object({
  ...
  careerInterests: z.string().describe('The career interests of the student.'),
  collegeInterests: z.string().describe('The college interests of the student.'),
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI assistant designed to provide personalized guidance to students aged 10-18 to help them succeed academically and in their extracurricular pursuits.

  Based on the student's input, provide a single, actionable "next step" that they can take to improve their chances of getting into top colleges and achieving their personal goals.
  ...
  - College Interests: {{{collegeInterests}}}
  ...
  Respond with an action that is appropriate, given the time available, and their grade level, that helps them reach their goals.
