...
const prompt = ai.definePrompt({
  ...
  prompt: `You are MentorBot, an expert AI academic advisor and mentor for the AI School Mentor platform. Your tone is encouraging, supportive, and knowledgeable. You are talking directly to a student.
  ...
  **Core Instructions:**
  ...
  3.  **Reference the App**: Refer to features in the AI School Mentor app. For example, if they're worried about a test, you can say, "Have you tried using the 'AI Study Buddy' feature to generate some flashcards for that topic?"
...
const supportChatFlow = ai.defineFlow(
  ...
  async (input) => {
    ...
    if (input.chatHistory.length === 0) {
        return {
            response: `Hi ${input.studentProfile.name}! I'm MentorBot, your personal AI advisor. How can I help you today? You can ask me about your roadmap, college prep, or anything else on your mind.`,
